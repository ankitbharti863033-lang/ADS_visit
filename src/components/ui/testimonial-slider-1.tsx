...
export const TestimonialSlider = ({
  ...
  return (
    <div
      className={cn(
        "relative w-full min-h-[650px] md:min-h-[600px] overflow-hidden bg-transparent text-zinc-50 p-8 md:p-12",
        className
      )}
    >
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8 h-full">
        {/* === Left Column: Meta and Thumbnails === */}
        <div className="md:col-span-3 flex flex-col justify-end order-2 md:order-1">
            ...
            {thumbnailReviews.map((review) => {
              ...
              return (
                <button
                  ...
                  className="overflow-hidden rounded-md w-16 h-20 md:w-20 md:h-24 opacity-50 hover:opacity-100 transition-opacity duration-300 focus:outline-none focus:ring-2 focus:ring-amber-500 focus:ring-offset-2 focus:ring-offset-zinc-950"
        ...
        <div className="md:col-span-5 flex flex-col justify-between md:pl-8 order-3 md:order-3">
          ...
          <div className="flex items-center space-x-2 mt-8 md:mt-0">
            <Button
              variant="outline"
              size="icon"
              className="rounded-full w-12 h-12 border-zinc-800 bg-zinc-900 text-zinc-50 hover:bg-zinc-800 hover:text-zinc-50"
              onClick={handlePrev}
            ...
            <Button
              variant="default"
              size="icon"
              className="rounded-full w-12 h-12 bg-amber-500 text-zinc-950 hover:bg-amber-400"
              onClick={handleNext}
